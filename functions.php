...
function rwpbs_setup() {
	 ...
	 * If you're building a theme based on Ready WP Boot Score, use a find and replace
	 * to change 'rwpbs' to the name of your theme in all the template files.
	 */
 ...
 */
function rwpbs_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'rwpbs_content_width', 640 );
}
add_action( 'after_setup_theme', 'rwpbs_content_width', 0 );
...
function rwpbs_scripts() {
	...
	wp_enqueue_script( 'rwpbs-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );
